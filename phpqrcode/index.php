...
if (!empty($autoData)) {
    // echo '<p style="color: green;"><strong>Data QR Code otomatis dari form:</strong></p>';
    echo '<p><strong>Isi QR Code:</strong> ' . htmlspecialchars($autoData) . '</p>';
    echo '<hr>';
}

//config form
echo '<form action="index.php" method="post">
    Data:&nbsp;<input name="data" value="'.(isset($_REQUEST['data'])?htmlspecialchars($_REQUEST['data']):(isset($autoData)?htmlspecialchars($autoData):'PHP QR Code Here')).'" size="50" />&nbsp;
