...
Nama Klien  <input  style="margin: 5px 5px 5px 20px;" type="text" name="name"><br>
Email  <input style="margin: 5px 5px 5px 24px;" type="text" name="email"><br>
Keterangan  <input style="margin: 5px 5px 5px 14px;" type="text" name="address"><br>
Kota  <input style="margin: 5px 5px 5px 26px;" type="text" name="city"><br>
Angka Acak <input style="margin: 5px 5px 5px 26px;" type="text"  name="msg"><br>
